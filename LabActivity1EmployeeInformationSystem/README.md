...
* **User Input:** Gathers employee information through interactive console prompts.  
* **Daily Salary Calculation:** Computes daily salary based on user-provided hours and hourly wage.  
* **Formatted Output:** Displays employee details and daily salary, with the salary formatted to two decimal places.
...
Enter hourly wage: \[e.g., 75.00\]

After you provide all the inputs, the program will output the employee's information and daily salary:

Employee Information  
\---------------------  
Full Name   : Charles Garcia  
Age         : 18 years old  
Daily Salary: PHP 637.50
